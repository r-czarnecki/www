let MemeHolder,Meme;_18b‍.w("../public/javascripts/memeHolder.js",[["MemeHolder",["MemeHolder"],function(v){MemeHolder=v}]]);_18b‍.w("../public/javascripts/meme",[["Meme",["Meme"],function(v){Meme=v}]]);
...
router.post('/meme/:memeId', function (req, res) {
  ...
  _18b‍.g.console.log(req.body.price);
  res.render('meme', { meme: meme })
});
