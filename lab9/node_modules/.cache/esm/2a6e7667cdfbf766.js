let MemeHolder,Meme;_cdf‍.w("../public/javascripts/memeHolder.js",[["MemeHolder",["MemeHolder"],function(v){MemeHolder=v}]]);_cdf‍.w("../public/javascripts/meme",[["Meme",["Meme"],function(v){Meme=v}]]);
...
router.post('/meme/:memeId', function (req, res) {
  ...
  _cdf‍.g.console.log(req.body.price);
  res.render('meme', { meme: meme })
});
